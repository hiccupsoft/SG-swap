...
const EarnCardContent: React.FC<{ headingText: string; bodyText: string; subheadingText: string; highlightColor: string }> = ({
  headingText,
  subheadingText,
  bodyText,
  highlightColor,
  ...
  return (
    ...
    >
      ...
      <Heading color="#FFF" scale="md" mb="20px">
        {subheadingText}
      </Heading>
...
export default EarnCardContent
